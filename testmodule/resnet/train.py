...
from testmodule.resnet.src import get_lr, warmup_cosine_annealing_lr
from testmodule.resnet.src import CrossEntropySmooth
from testmodule.resnet.src import EvalCallBack
from testmodule.resnet.src import DistAccuracy, ClassifyCorrectCell
from testmodule.resnet.src import config
from testmodule.resnet.src import moxing_wrapper
from testmodule.resnet.src import get_rank_id, get_device_num
from testmodule.resnet.src import conv_variance_scaling_initializer
...
if config.net_name in ("resnet18", "resnet34", "resnet50", "resnet152"):
    if config.net_name == "resnet18":
        from testmodule.resnet.src import resnet18 as resnet
    elif config.net_name == "resnet34":
        from testmodule.resnet.src import resnet34 as resnet
    elif config.net_name == "resnet50":
        from testmodule.resnet.src import resnet50 as resnet
    else:
        from testmodule.resnet.src import resnet152 as resnet
    if config.dataset == "cifar10":
        from testmodule.resnet.src import create_dataset1 as create_dataset
    else:
        if config.mode_name == "GRAPH":
            from testmodule.resnet.src import create_dataset2 as create_dataset
        else:
            from testmodule.resnet.src import create_dataset_pynative as create_dataset
elif config.net_name == "resnet101":
    from testmodule.resnet.src import resnet101 as resnet
    from testmodule.resnet.src import create_dataset3 as create_dataset
else:
    from testmodule.resnet.src import se_resnet50 as resnet
    from testmodule.resnet.src import create_dataset4 as create_dataset
...
def init_lr(step_size):
    ...
    if config.optimizer == "Thor":
        from testmodule.resnet.src import get_thor_lr
...
def train_net():
    ...
    if config.optimizer == "Thor" and config.dataset == "imagenet2012":
        from testmodule.resnet.src import get_thor_damping
