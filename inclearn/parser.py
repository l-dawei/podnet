"""
 ...
 To get parser for training
 This file is totally the same as origin project, I didn't modify anything
"""
...
def get_parser():
    ...
    parser.add_argument("--device_target", default='Ascend', type=str,
                        help="CPU/Ascend/GPU, but now only support Ascend")
    ...
    parser.add_argument("-resume", "--resume", default=None,
                        help="Resume from previously saved model, "
                             "must be in the format `*_task_[0-9]+\.ckpt`.")
